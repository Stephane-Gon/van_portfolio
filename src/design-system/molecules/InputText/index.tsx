  ...
  return (
    <div id={id} className="relative h-11 w-full min-w-[200px]">
      <input 
        ...
        className="peer h-full w-full border-b bg-[#00000000] border-primaryPink pt-4 pb-1.5 font-sans text-sm font-normal text-smothWhite outline outline-0 transition-all placeholder-shown:border-primaryPink focus:border-primaryBlue focus:outline-0 disabled:border-0 disabled:bg-blue-gray-50" />
      <label
