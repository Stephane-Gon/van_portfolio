  ...
  return (
    <div className=' m-0 flex items-center justify-center overflow-hidden'>
      <div
        ...
        className='absolute z-1 h-[30px] w-[60px] cursor-pointer rounded-[100px] border-[2px] border-[#65c0e7] bg-[#9cd6ef]'></div>
      <div
        id='night'
        ref={night}
        onClick={() => handleNightClick()}
        className='pointer-events-none absolute z-1 h-[30px] w-[60px] cursor-pointer rounded-[100px] border-[2px] border-[#65c0e7] bg-[#9cd6ef]'></div>
      ...
      <svg
        ...
        xmlSpace='preserve'
        className='pointer-events-none z-2 scale-70'>
        <g>
          <polygon
            className='star'
            id='star-1'
